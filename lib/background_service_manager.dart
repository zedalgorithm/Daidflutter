...
// Health check task
Future<void> _healthCheckTask() async {
  try {
    ...
    await prefs.setString('connectivity', connectivityResult.name);
    
    print('✅ Health check completed. Battery: $batteryLevel%, Connectivity: ${connectivityResult.name}');
  } catch (e) {
    print('❌ Error in health check task: $e');
  }
}
