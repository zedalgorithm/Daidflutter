...
class ReportPoliceEmergencyPage extends StatefulWidget {
  ...
  @override
  _ReportPoliceEmergencyPageState createState() =>
      _ReportPoliceEmergencyPageState();
}
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: const Color(0xFF2451C5), // AppBar background color
        ),
        body: Column(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Expanded(
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: selectedButton == 0 ? Color(0xFF2451C5) : Colors.white,
                    foregroundColor: selectedButton == 0 ? Colors.white : Color(0xFF2451C5),
                    padding:
              ...
              Expanded(
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: selectedButton == 1 ? Color(0xFF2451C5) : Colors.white,
                    foregroundColor: selectedButton == 1 ? Colors.white : Color(0xFF2451C5),
                    padding:
                        EdgeInsets.symmetric(vertical: screenHeight * 0.02),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(8),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: selectedEmergencyType == 0 ? Color(0xFF2451C5) : Colors.white,
              border: Border.all(
                color:
              ...
              children: [
                Padding(
                  ...
                  child: Icon(
                    ...
                    color: selectedEmergencyType == 0 ? Colors.white : const Color(0xFF2451C5),
                    size: 25,
                  ),
                ),
